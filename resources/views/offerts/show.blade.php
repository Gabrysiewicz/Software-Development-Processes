...
<x-layout>
    <section id='section-offert'>
        <div id='background-image' style="background-image:url('{{asset('images/background-banner.jpg')}}')">
        ...
        <div id='intro'>
            ...
            <div id='social-media'>
                ...
                @endif
                @if (isset($offert->facebook))
                <a href="{{$offert->facebook}}">
                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-facebook" viewBox="0 0 16 16">
                        <path d="M16 8.049c0-4.446-3.582-8.05-8-8.05C3.58 0-.002 3.603-.002 8.05c0 4.017 2.926 7.347 6.75 7.951v-5.625h-2.03V8.05H6.75V6.275c0-2.017 1.195-3.131 3.022-3.131.876 0 1.791.157 1.791.157v1.98h-1.009c-.993 0-1.303.621-1.303 1.258v1.51h2.218l-.354 2.326H9.25V16c3.824-.604 6.75-3.934 6.75-7.951z"/>
                    </svg>
                </a>
                @endif
                @if (isset($offert->instagram))
                <a href="{{$offert->instagram}}">
                ...
                @endif
                @if (isset($offert->tiktok))
                <a href="{{$offert->tiktok}}">
                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-tiktok" viewBox="0 0 16 16">
                        <path d="M9 0h1.98c.144.715.54 1.617 1.235 2.512C12.895 3.389 13.797 4 15 4v2c-1.753 0-3.07-.814-4-1.829V11a5 5 0 1 1-5-5v2a3 3 0 1 0 3 3V0Z"/>
                    </svg>
                </a>
                @endif
                @if (isset($offert->twitter))
                <a href="{{$offert->twitter}}">
        ...
        <div id='description'>
            @if ( isset($offert->description) && $offert->description !== "")
                <h3>Description</h3>
                <p id='description-text'>{!!$offert->description!!}</p>
            @else
                <h3>Description: </h3>
                <p id='description-text-blank'>This user don't have any description</p>
            @endif
        </div>
    </section>
</x-layout>
